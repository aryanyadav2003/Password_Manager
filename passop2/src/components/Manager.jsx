...
const Manager=()=>{
    ...
    return(
        ...
        <div className="text-black flex flex-col p-4 gap-8 items-center">
            ...
            <button onClick={savePassword} className="flex justify-center items-center gap-2 bg-green-400 rounded-full px-4 py-2 w-fit hover:bg-green-300 border border-green-900">
            <lord-icon
